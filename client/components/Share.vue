<template>
    <h5 class="color">Share this</h5>
    <ShareNetwork
        network="facebook"
        url=""
        :title='post.title'
        :description='post.preview'
        :hashtags='post.tags.map(obj => obj.slug).join(",")'>
